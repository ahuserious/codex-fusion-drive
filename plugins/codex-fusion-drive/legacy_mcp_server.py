...
TOOLS = [
    ...
    _tool(
        "execution_handoff",
        "Read the persisted Codex host-workflow packet from a completed run, including its frozen profile/settings, selected artifacts, and pending lifecycle gates. This tool never launches a recursive Claude process.",
        {"run_id": {"type": "string"}},
        ["run_id"],
    ),
]
